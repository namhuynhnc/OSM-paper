...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL2/IL2.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL4/IL4.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL7/IL7.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IFNg/IFNg.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IFNa/IFNa.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IFNb/IFNb.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.bind, paste0("./Output_new4_30/Try9_JAK_CIA/IL10/IL10.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/OSM/OSM.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL6/IL6.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL22/IL22.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL15/IL15.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/IL21/IL21.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/GM-CSF/GM-CSF.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/EPO/EPO.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
...
for(i in 1: length(levels(seuset@active.ident))){
  ...
  print(gene_numbers[[i]])
  write.table(list.merge, paste0("./Output_new4_30/Try9_JAK_CIA/GH/GH.",i,".txt"), sep="\t", quote=FALSE, row.names=FALSE)
}
all$Gh <- gene_numbers
...
target_data <- cbind.fill(Il2_, Il4_, Il7_, Il15_, Il21_, Il6_, Osm_, Ifna_, Ifnb_, Il10_, Il22_, Ifng_, Csf2_, Epo_, Gh_)
colnames(target_data) <- rev(c("GH","EPO","CSF2","IFNG","IL22","IL10","IFNB","IFNA","OSM","IL6","IL21","IL15","IL7","IL4","IL2"))

write.table(target_data,"./Output_new4_30/Try9_JAK_CIA/All/cytokine_targets.txt", sep="\t", quote=FALSE, row.names=FALSE)
...
write.table(all, "./Output_new4_30/Try9_JAK_CIA/All/all_scale.txt", sep="\t", quote=FALSE, row.names=T)

all <- read.table("./Output_new4_30/Try9_JAK_CIA/All/all_scale.txt", sep="\t", header = T)
...
pdf("./Output_new4_30/Try9_JAK_CIA/All/All_scale.pdf", height = 5, width = 5)
# Matrix heatmap
...
# CIA vs JAK1i
all_JAK1i <- read.table("./Output_new4_30/Try9_JAK_JAK1i/All/all_scale.txt", sep="\t", header = T)
all_JAK1i$cell <- rownames(all_JAK1i)

plotDat_JAK1i <- gather(all_JAK1i, key = "Cytokine", value = "Percent_target_gene", -cell)
plotDat_JAK1i$cell <- factor(plotDat_JAK1i$cell,levels = all_JAK1i$cell)
plotDat_JAK1i$Cytokine <- factor(plotDat_JAK1i$Cytokine,levels = rev(colnames(all_JAK1i)[1:15]))

plotDat_change <- cbind(plotDat, plotDat_JAK1i)
plotDat_change <- plotDat_change[,-c(4,5)]
plotDat_change$Percent_target_gene_CIA_vs_JAK1i <- (plotDat_change$Percent_target_gene-plotDat_change$Percent_target_gene.1)
#plotDat_change$Percent_target_gene_CIA_vs_JAK1i <- ((plotDat_change$Percent_target_gene-plotDat_change$Percent_target_gene.1)/plotDat_change$Percent_target_gene)

pdf("./Output_new4_30/Try9_JAK_CIA/All/All_scale_change.pdf", height = 5.5, width = 5.5)
# Matrix heatmap
ggplot(plotDat_change, aes(Cytokine, cell, col = Percent_target_gene_CIA_vs_JAK1i, fill = Percent_target_gene_CIA_vs_JAK1i, label = Percent_target_gene_CIA_vs_JAK1i)) +
  geom_tile() +
#  geom_text(col = "black",size=1.9) +
  theme_minimal() +
  scale_fill_gradient2(low = "lightgrey", high = "red") +
  #  scale_color_gradient2(low = "lightgrey", high = "blue") +
  scale_y_discrete(breaks=cluster_name$number,
  ...
  theme(axis.text.x = element_text(angle = 90,vjust = 0.5, hjust = 1, size = 8),
        axis.text.y = element_text(size = 7),aspect.ratio = 1)
dev.off()
